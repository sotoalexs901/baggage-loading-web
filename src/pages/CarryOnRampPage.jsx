    ...
    >
      ...
      >
        <div>
          ...
          >
            Receive Carry-Ons from Gate, then confirm final aircraft loading compartment.
          </p>
        </div>
      ...
      {selectedFlight ? (
        <>
          ...
          {!canOperateRamp && (
            <Notice
              tone="warning"
              text="You can view Ramp status, but your current role/operational position cannot confirm receipt or loading."
            />
          )}
          ...
          >
            ...
            0 ? (
              ...
              >
                No Carry-On items are ready for aircraft loading.
              </p>
            ) : (
              <div
                style={{
