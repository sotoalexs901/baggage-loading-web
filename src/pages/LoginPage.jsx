    ...
    try {
      ...
      const savedGateController =
        role === "gate_controller"
          ? userData.username
          : localStorage.getItem("gateControllerOnDuty") || null;

      onLogin(userData, {
        gateControllerUsername: savedGateController,
      });
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: "0.7rem", textAlign: "center", color: "#9ca3af", marginTop: "4px" }}>
          Use your assigned <strong>username</strong> and <strong>PIN</strong>.
        </p>
      </div>
    </div>
  );
